...
2. **Tokens:** `bg-background`, `text-foreground`, `bg-primary`, `text-primary-foreground`. No fijar colores de marca fijos en hex salvo neutros; el primario depende de `NEXT_PUBLIC_PRIMARY_HUE`.
